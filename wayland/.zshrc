...
alias -g swrc='nvim $HOME/.config/sway/config'
...
alias -g y18p='youtube-dl -f 18 --yes-playlist'
alias -g yta='youtube-dl -f bestaudio'
alias -g ytlp='youtube-dl --flat-playlist --skip-download'
alias -g y18pi='youtube-dl -f 18  --playlist-items'
alias -g ytapi='youtube-dl -f bestaudio  --playlist-items'
alias -g pasi='pass insert'
alias -g pase='pass edit'
alias -g zoomscreencap="sudo modprobe v4l2loopback && wf-recorder --muxer=v4l2 --codec=rawvideo -x yuv420p --file=/dev/video5"
alias -g sway="sway > /var/log/sway.log 2>&1"
